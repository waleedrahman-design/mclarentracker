# 🏎️ McLaren F1 &bull; Google Cloud Trackside Telemetry Portal
...
> **Internal Go Link:** `go/waleed-f1` • `go/mclaren-edge`  
...
- **🏎️ Real-Time Vehicle Dynamics Engine:** Live simulated telemetry traces for **Lando Norris (#4)** and **Oscar Piastri (#81)** including Speed (km/h), RPM with dynamic redline, Gear selection, Throttle/Brake traces, ERS battery deployment, and 4-corner tire temperatures (FL/FR/RL/RR).
- **⏱️ Sector Deltas & Lap Comparisons:** Live tracking of Sector 1, 2, and 3 deltas featuring overall fastest (purple) and personal best (green) telemetry flags.
- **☁️ Implementation Engineer / Edge Systems View:**
